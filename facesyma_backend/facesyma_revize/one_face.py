...
def Cal1(img):
    ...
    def Eye():
        ...
        eyes_dic = {"eyes_distance":  eyes_distance_result, "eyes_size": eyes_size_result, "eyes_compare": eyes_compare}
        return eyes_dic
    ...
    def Eyebrow():
        ...
        eyebrow_dic = {"eyebrows_eyes_distance": eyebrows_eyes_distance_result}
    ...
    def Lip():
        ...
        lip_dic = {"lips_width": lips_width_result, "lips_thickness":  lips_thickness_result, "lips_height_compare": lips_height_compare_result, "lips_height_status_result": lips_height_status_result}
        return lip_dic
    ...
    def Nose():
        ...
        nose_dic = {"nose_length": nose_length_result, "nose_width": nose_width_result, "nose_size": nose_size}
    ...
    def Forehead():
        ...
        forehead_dic = {"forehead_distance": forehead_distance_result}
